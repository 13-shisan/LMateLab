...
STAGE10_MANIFEST_PATHS = (
    ...
    "backend/competition_runtime.py",
    ...
    "backend/models_competition_agent.py",
    "backend/requirements-107cup.txt",
    "backend/scripts/import_qmof_structure_index.py",
    "backend/scripts/install_qmof_dataset.py",
    "backend/routers/competition_agent.py",
    "backend/routers/competition_cluster.py",
    "backend/routers/competition_workflows.py",
    "backend/schemas.py",
    "backend/schemas_competition_agent.py",
    "backend/schemas_workflow.py",
    "backend/services/competition_agent/catalog.py",
    "backend/services/competition_agent/controlled_qoder_tools.py",
    "backend/services/competition_agent/examples.py",
    "backend/services/competition_agent/literature.py",
    "backend/services/competition_agent/llm_runtime.py",
    "backend/services/competition_agent/planning.py",
    "backend/services/competition_agent/qoder_runtime.py",
    "backend/services/competition_agent/service.py",
    "backend/services/competition_agent/settings.py",
    "backend/services/competition_agent/structure_library.py",
    "backend/services/competition_agent/structures.py",
    "backend/services/competition_agent/tools.py",
    "backend/services/competition_agent/uploads.py",
    "backend/services/competition_agent/vasp_analysis.py",
    "backend/services/competition_agent/worker.py",
    "backend/services/competition_attempt_inputs.py",
    "backend/services/competition_coordinator.py",
    "backend/services/competition_cluster_resources.py",
    ...
    "backend/services/qoder_management.py",
    "backend/tests/test_107cup_agent_deploy_contract.py",
    "backend/tests/test_107cup_agent_deploy_runtime.py",
    "backend/tests/test_107cup_authz.py",
    "backend/tests/test_107cup_deploy_contract.py",
    "backend/tests/test_107cup_runtime.py",
    "backend/tests/test_qmof_dataset_install.py",
    ...
    "backend/tests/test_competition_agent_catalog.py",
    "backend/tests/test_competition_agent_qoder_tools.py",
    "backend/tests/test_competition_agent_fake_slurm.py",
    "backend/tests/test_competition_agent_literature.py",
    "backend/tests/test_competition_agent_migration.py",
    "backend/tests/test_competition_agent_registration.py",
    "backend/tests/test_competition_agent_routes.py",
    "backend/tests/test_competition_agent_runtime.py",
    "backend/tests/test_competition_agent_security.py",
    "backend/tests/test_competition_agent_structures.py",
    "backend/tests/test_competition_agent_tools.py",
    "backend/tests/test_competition_cluster_resources.py",
    ...
    "deploy/107cup/agent-worker.slurm",
    "deploy/107cup/agent_worker_control.py",
    "deploy/107cup/build.slurm",
    "deploy/107cup/generate-slurm-job-ledger.py",
    "deploy/107cup/generate-stage10-manifest.py",
    "deploy/107cup/prepare-databases.py",
    "deploy/107cup/qmof-library.slurm",
    "deploy/107cup/relay/nginx.conf.example",
    "deploy/107cup/runtime.env.example",
    ...
    "deploy/107cup/submit-qmof-library.sh",
    ...
    "frontend/e2e/competition-preview.spec.js",
    "frontend/e2e/competition-workbench-visual.spec.js",
    "frontend/src/App107Cup.jsx",
    "frontend/src/components/AppShell.jsx",
    "frontend/src/components/AppShell.css",
    "frontend/src/config/appNavigation.js",
    ...
    "frontend/src/features/competition/agent/CompetitionAgent.css",
    "frontend/src/features/competition/agent/CompetitionAgent.jsx",
    "frontend/src/features/competition/agent/StructureBuilder.jsx",
    ...
    "frontend/src/features/competition/data/demoCompetitionDataProvider.js",
    "frontend/src/features/competition/data/demoFixtures.js",
    "frontend/src/pages/Login.jsx",
    "frontend/src/pages/competition/CompetitionServer.css",
    "frontend/src/pages/competition/CompetitionServer.jsx",
    ...
    "frontend/tests/competitionAgent107Cup.test.mjs",
    "frontend/tests/appNavigation107Cup.test.mjs",
