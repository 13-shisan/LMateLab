...
当前公网入口额外允许以下校园网出口网段：`114.214.160.0/19`、`114.214.192.0/18`、
`202.38.64.0/19`、`210.45.64.0/20`、`210.45.112.0/20`、`211.86.144.0/20`、
`222.195.64.0/19`、`210.72.22.0/24`、`202.141.160.0/19`、`218.22.21.0/27` 和
`218.104.71.160/28`。这些规则只决定来源 IP 能否到达 `18733`；登录、角色、资源归属和精确 HTTP 方法门禁仍然生效，注册 POST 仍未开放。
...
```text
/home/scc/pb23030683/lmatelab-107cup/logs/build-63251.{out,err}
/home/scc/pb23030683/lmatelab-107cup/logs/qoder-controlled-acceptance-63233.{out,err}
