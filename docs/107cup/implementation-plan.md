...
| 8. 结果解析与证据包 | PARTIAL | PR `#42-#44` 已合并；Job `40307` 构建、Job `40308` 真实只读解析及 Job `40309` 稳定部署通过，结构/BAND/DOS/五种下载和确定性证据包均有真实 SHA-256；证据 PR `#45` 已合并 | 完成 Viewer/Operator 浏览器验收、清理回滚服务与临时转发，再通过最终状态 PR 改为 `DONE` |
