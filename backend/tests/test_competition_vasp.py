...
class ScientificAcceptanceTests(unittest.TestCase):
    ...
    def test_band_accepts_vaspkit_302_path_with_generator_evidence(self):
        self.write_complete_outputs("band")
        self.write(
            "KPOINTS",
            b"K-Path Generated by VASPKIT.\n20\nLine-Mode\nReciprocal\n"
            b"0 0 0 GAMMA\n0.5 0 0 M\n\n"
            b"0.5 0 0 M\n0.333333 0.333333 0 K\n\n"
            b"0.333333 0.333333 0 K\n0 0 0 GAMMA\n",
        )
        self.write(
            "BAND_PATH.policy",
        ...
        report = self.accept("band")

        self.assertTrue(report.accepted, report.as_dict())
        self.assertIn("band-path-generator.txt", {item["name"] for item in report.artifacts})

    def test_generated_band_path_rejects_missing_or_malformed_labels(self):
        for coordinate in (
            b"0 0 0\n",
            b"0 0 0 GAMMA extra\n",
            b"0 0 0 !\n",
